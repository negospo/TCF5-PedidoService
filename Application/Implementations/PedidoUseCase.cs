...
namespace Application.Implementations
{
    public class PedidoUseCase : Interfaces.UseCases.IPedidoUseCase
    {
        ...
        private readonly IPedidoPagamentoMessage _pedidoPagamentoMessage;

        public PedidoUseCase(IPedidoRepository pedidoRepository,IClienteRepository clienteRepository, IProdutoRepository produtoRepository, IPedidoStatusUseCase pedidoStatusUseCase, IPedidoPagamentoUseCase pedidoPagamentoUseCase, IPedidoPagamentoMessage pedidoPagamentoMessage)
        {
            ...
            this._pedidoPagamentoMessage = pedidoPagamentoMessage;
        }
        ...
        public DTOs.Output.PedidoIdentificador Order(DTOs.Imput.Pedido pedido)
        {
            ...
            //Envia a mensagem para a fila de Pagamento
            this._pedidoPagamentoMessage.SendToQueue(new DTOs.External.PagamentoService.PedidoPagamentoRequest
            {
                PedidoId = identifier,
