...
namespace TestBDD.StepDefinitions
{
    ...
    public class PedidoUseCaseStepDefinitions
    {
        ...
        readonly Mock<IPedidoPagamentoMessage> _mockPedidoPagamentoMessage;
        ...
        public PedidoUseCaseStepDefinitions()
        {
            ...
            _mockPedidoPagamentoMessage = new Mock<IPedidoPagamentoMessage>();
            ...
            _pedidoUseCase = new PedidoUseCase(
                ...
                _mockPedidoPagamentoMessage.Object
            );
